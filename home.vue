                        	        ...
                        	        <a :href="feature.url">
                            			...
                            			<div class="feature_item_info" v-if="feature.name && feature.description">
                            				<div :class="'feature_item_content ' + feature.text_class + feature.border">
                            					...
                            					<!--</div>-->
                            					<div class="feature_item_more"> <!-- v-else -->
        ...
        return Vue.component("home-component", {
            ...
            methods: {
                loadData: async function() {
                    try {
                        let results = await Promise.all([this.$store.dispatch("getData", "banners"), this.$store.dispatch("getData", "feature_items"), this.$store.dispatch("getData", "popups"), this.$store.dispatch('LOAD_PAGE_DATA', {url: "https://stlaurent.mallmaverick.com/api/v4/stlaurent/social.json"})]);
                        return results;
                    } catch (e) {
